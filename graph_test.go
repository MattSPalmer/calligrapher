...
func TestDistribution(t *testing.T) {
  ...
  expectedByHour := map[int64]int{12:2, 13:1, 16:1, 23:1, 4:1}
  expectedByDuration := map[int64]int{5:4, 0:2}
  expectedByAgent := map[int64]int{5550001111:2, 5550001112:1, 5550001113:1, 0:2}
